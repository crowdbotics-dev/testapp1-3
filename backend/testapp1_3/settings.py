"""
Django settings for testapp1_3 project.
...
WSGI_APPLICATION = 'testapp1_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp1_3 API",
    "DESCRIPTION": "API documentation for testapp1_3 App",
    "VERSION": "v1",
}
